...
if((i < len)){
var k = (ks[i]);
var G__968 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__969 = (i + (1));
m = G__968;
i = G__969;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__970 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__970) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__970));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__972 = c;
var G__972__$1 = (((G__972 == null))?null:G__972.prototype);
if((G__972__$1 == null)){
return null;
} else {
return (G__972__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__974 = c;
var G__974__$1 = (((G__974 == null))?null:G__974.prototype);
if((G__974__$1 == null)){
return null;
} else {
return (G__974__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__978__delegate = function (args){
var G__976 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__976) : reagent.impl.component.as_element.call(null,G__976));
};
var G__978 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__979__i = 0, G__979__a = new Array(arguments.length -  0);
while (G__979__i < G__979__a.length) {G__979__a[G__979__i] = arguments[G__979__i + 0]; ++G__979__i;}
  args = new cljs.core.IndexedSeq(G__979__a,0,null);
} 
return G__978__delegate.call(this,args);};
G__978.cljs$lang$maxFixedArity = 0;
G__978.cljs$lang$applyTo = (function (arglist__980){
var args = cljs.core.seq(arglist__980);
return G__978__delegate(args);
});
G__978.cljs$core$IFn$_invoke$arity$variadic = G__978__delegate;
return G__978;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR__orig_val__982 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__983 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__983;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__982;
}});
...
var G__984 = key;
var G__984__$1 = (((G__984 instanceof cljs.core.Keyword))?G__984.fqn:null);
switch (G__984__$1) {
...
return ((function (G__984,G__984__$1){
...
var c = this;
var G__989_991 = (c["cljsRatom"]);
if((G__989_991 == null)){
} else {
reagent.ratom.dispose_BANG_(G__989_991);
}
...
var renders_993 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_994 = cljs.core.first(cljs.core.vals(renders_993));
if((cljs.core.count(renders_993) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_993))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_994)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_994], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__992 = name;
switch (G__992) {
case "":
...
var G__997 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__997) : reagent.impl.component.global$module$create_react_class.call(null,G__997));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__998 = fiber;
var G__998__$1 = (((G__998 == null))?null:(G__998["type"]));
if((G__998__$1 == null)){
return null;
} else {
return (G__998__$1["displayName"]);
}
})();
var parent = (function (){var G__999 = fiber;
if((G__999 == null)){
return null;
} else {
return (G__999["return"]);
}
})();
var path = (function (){var G__1000 = parent;
var G__1000__$1 = (((G__1000 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__1000) : reagent.impl.component.fiber_component_path.call(null,G__1000)));
if((G__1000__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1000__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__1002 = c;
if((G__1002 == null)){
return null;
} else {
return (G__1002["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__1003._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__1005 = c;
if((G__1005 == null)){
return null;
} else {
return (G__1005["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__1007 = c;
if((G__1007 == null)){
return null;
} else {
return G__1007._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__1009 = instance;
if((G__1009 == null)){
return null;
} else {
return (G__1009["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__1010 = instance;
if((G__1010 == null)){
return null;
} else {
return G__1010._currentElement;
}
}
})();
var name = (function (){var G__1011 = elem;
var G__1011__$1 = (((G__1011 == null))?null:(G__1011["type"]));
if((G__1011__$1 == null)){
return null;
} else {
return (G__1011__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__1013 = elem;
if((G__1013 == null)){
return null;
} else {
return (G__1013["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__1014._owner;
}
}
})();
var path = (function (){var G__1015 = owner;
var G__1015__$1 = (((G__1015 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__1015) : reagent.impl.component.component_path.call(null,G__1015)));
if((G__1015__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1015__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
return reagent.impl.util.fun_name(G__1016__$1);
}
}
})();
