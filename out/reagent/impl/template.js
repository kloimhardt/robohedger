...
var G__1036 = o;
(G__1036[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__1037__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__1037 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1038__i = 0, G__1038__a = new Array(arguments.length -  0);
while (G__1038__i < G__1038__a.length) {G__1038__a[G__1038__i] = arguments[G__1038__i + 0]; ++G__1038__i;}
  args = new cljs.core.IndexedSeq(G__1038__a,0,null);
} 
return G__1037__delegate.call(this,args);};
G__1037.cljs$lang$maxFixedArity = 0;
G__1037.cljs$lang$applyTo = (function (arglist__1039){
var args = cljs.core.seq(arglist__1039);
return G__1037__delegate(args);
});
G__1037.cljs$core$IFn$_invoke$arity$variadic = G__1037__delegate;
return G__1037;
})()
;
} else {
...
var G__1040 = o;
(G__1040[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__1041__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__1042__i < G__1042__a.length) {G__1042__a[G__1042__i] = arguments[G__1042__i + 0]; ++G__1042__i;}
  args = new cljs.core.IndexedSeq(G__1042__a,0,null);
} 
return G__1041__delegate.call(this,args);};
G__1041.cljs$lang$maxFixedArity = 0;
G__1041.cljs$lang$applyTo = (function (arglist__1043){
var args = cljs.core.seq(arglist__1043);
return G__1041__delegate(args);
});
...
var G__1045 = props;
var G__1045__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__1045,cljs.core.cst$kw$id,id):G__1045);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__1045__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__1046){
var map__1047 = p__1046;
var map__1047__$1 = (((((!((map__1047 == null))))?(((((map__1047.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1047.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1047):map__1047);
var props = map__1047__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1047__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__1047,map__1047__$1,props,class$){
return (function (c){
...
});})(map__1047,map__1047__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__1049){
...
return reagent.impl.batching.do_after_render(((function (node_value,map__1050,map__1050__$1,on_write){
return (function (){
...
});})(node_value,map__1050,map__1050__$1,on_write))
);
} else {
...
var G__1053 = jsprops;
(G__1053["defaultValue"] = value);

(G__1053["onChange"] = ((function (G__1053,v,value,on_change){
return (function (p1__1052_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__1052_SHARP_);
});})(G__1053,v,value,on_change))
);
...
var vec__1056 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1056,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1056,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1056,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___1060 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___1060 == null)){
} else {
var key_1061 = temp__5724__auto___1060;
(jsprops["key"] = key_1061);
}
...
var temp__5724__auto___1062 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___1062 == null)){
} else {
var key_1063 = temp__5724__auto___1062;
reagent.impl.template.oset(jsprops,"key",key_1063);
}
...
var G__1064 = reagent.impl.template.__GT_NativeWrapper();
(G__1064["name"] = c);
...
var G__1065 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__1065) : reagent.impl.template.as_element.call(null,G__1065));
} else {
...
var len__4730__auto___1071 = arguments.length;
var i__4731__auto___1072 = (0);
while(true){
if((i__4731__auto___1072 < len__4730__auto___1071)){
args__4736__auto__.push((arguments[i__4731__auto___1072]));

var G__1073 = (i__4731__auto___1072 + (1));
i__4731__auto___1072 = G__1073;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq1069){
var G__1070 = cljs.core.first(seq1069);
var seq1069__$1 = cljs.core.next(seq1069);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1070,seq1069__$1);
});
...
break;
default:
var G__1076 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__1076;
continue;
...
var n__4607__auto___1078 = a.length;
var i_1079 = (0);
while(true){
if((i_1079 < n__4607__auto___1078)){
(a[i_1079] = reagent.impl.template.as_element((a[i_1079])));

var G__1080 = (i_1079 + (1));
i_1079 = G__1080;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___1081 = a.length;
var i_1082 = (0);
while(true){
if((i_1082 < n__4607__auto___1081)){
var val_1083 = (a[i_1082]);
if(((cljs.core.vector_QMARK_(val_1083)) && ((reagent.impl.template.key_from_vec(val_1083) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_1082] = reagent.impl.template.as_element(val_1083));

var G__1084 = (i_1082 + (1));
i_1082 = G__1084;
continue;
} else {
}
...
var ctx = ({});
var vec__1085 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1085,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1085,(1),null);
...
var G__1088 = (cljs.core.count(argv) - first_child);
switch (G__1088) {
case (0):
...
var G__1089 = comp;
var G__1090 = jsprops;
var G__1091 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__1089,G__1090,G__1091) : reagent.impl.template.global$module$react.createElement.call(null,G__1089,G__1090,G__1091));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__1088){
