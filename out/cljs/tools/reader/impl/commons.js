...
var G__1410 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__1410;
continue;
} else {
return ch;
...
var vec__1411 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1411,(0),null);
return (match === s);
});
