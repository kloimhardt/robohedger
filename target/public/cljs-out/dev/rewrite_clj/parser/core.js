...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__27607_SHARP_){
var _STAR_delimiter_STAR__orig_val__27608 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__27609 = delimiter;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__27609;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__27607_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__27608;
}}));
});
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__27614){
var vec__27615 = p__27614;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__27615,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq27610){
...
var G__27613 = cljs.core.first.call(null,seq27610__$2);
var seq27610__$3 = cljs.core.next.call(null,seq27610__$2);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27611,G__27612,G__27613,seq27610__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__27621 = rewrite_clj.reader.peek.call(null,reader);
switch (G__27621) {
case "(":
...
var G__27623 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__27623)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"\"",G__27623)){
...
if(cljs.core._EQ_.call(null,"_",G__27623)){
