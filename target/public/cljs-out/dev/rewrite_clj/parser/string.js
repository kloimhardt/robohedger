...
if((c === "\n")){
var G__27601 = escape_QMARK_;
var G__27602 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__27601;
lines = G__27602;
continue;
} else {
buf.append(c);

var G__27603 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__27604 = lines;
escape_QMARK_ = G__27603;
lines = G__27604;
continue;
