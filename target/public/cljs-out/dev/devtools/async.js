...
var o__25150__auto___33463 = (function (){var o__25150__auto__ = (function (){var o__25150__auto__ = Promise;
return (o__25150__auto__["resolve"]).call(o__25150__auto__);
})();
return (o__25150__auto__["then"]).call(o__25150__auto__,callback);
})();
(o__25150__auto___33463["catch"]).call(o__25150__auto___33463,devtools.async.rethrow_outside_promise);
...
var G__33464_33465 = Error;
var target__25155__auto___33466 = G__33464_33465;
if(cljs.core.truth_(target__25155__auto___33466)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33464_33465)].join(''),"\n","target__25155__auto__"].join('')));
}

(target__25155__auto___33466["stackTraceLimit"] = Infinity);
