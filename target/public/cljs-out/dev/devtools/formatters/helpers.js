...
var G__26145 = devtools.prefs.pref.call(null,v);
v = G__26145;
continue;
} else {
return v;
...
}catch (e26148){var _e__25157__auto__ = e26148;
return false;
}})();
...
}catch (e26152){var _e__25157__auto__ = e26152;
return false;
}})();
...
}catch (e26154){var _e__25157__auto__ = e26154;
return false;
}}
}
});
...
var vec__26156 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__26156,(0),null);
var name = cljs.core.nth.call(null,vec__26156,(1),null);
...
return cljs.core.some.call(null,(function (p1__26159_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__26159_SHARP_);
}),template);
});
