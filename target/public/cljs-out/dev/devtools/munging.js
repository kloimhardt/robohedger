...
var o26040 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26040["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26041 = temp__5718__auto____$1;
return (o26041["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25150__auto__ = f;
return (o__25150__auto__["toString"]).call(o__25150__auto__);
} else {
return "";
}
}catch (e26042){var _ = e26042;
return "";
}});
...
try{var o__25150__auto___26044 = t;
(o__25150__auto___26044["cljs$lang$ctorPrWriter"]).call(o__25150__auto___26044,t,writer);
}catch (e26043){var __26045 = e26043;
}
...
var char_code = (function (){var o__25150__auto__ = (new String(char$));
return (o__25150__auto__["charCodeAt"]).call(o__25150__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25150__auto__ = String;
return (o__25150__auto__["fromCharCode"]).call(o__25150__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26046 = num_code;
switch (G__26046) {
case (1):
return (185);
...
var o__25150__auto__ = String;
return (o__25150__auto__["fromCharCode"]).call(o__25150__auto__,superscript_code);
});
/**
...
}catch (e26048){var _e__25157__auto__ = e26048;
return false;
}})())){
...
var vec__26049 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26049,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o26052 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26052["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26053 = temp__5718__auto____$1;
return (o26053["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26056){
var vec__26057 = p__26056;
var ns_detector = cljs.core.nth.call(null,vec__26057,(0),null);
...
var G__26063 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26064 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26063;
remaining_tokens = G__26064;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26054){
...
var vec__26068 = cljs.core.split_with.call(null,(function (p1__26067_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26067_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26068,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26068,(1),null);
...
var vec__26074 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26074,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26074,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26077 = cljs.core.rest.call(null,remaining_tokens);
var G__26078 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26077;
name_tokens = G__26078;
continue;
} else {
...
var vec__26081 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26081,(0),null);
var arity = cljs.core.nth.call(null,vec__26081,(1),null);
var vec__26084 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26084,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26084,(1),null);
var vec__26087 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26087,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26087,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26087,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26087,(3),null);
...
var vec__26093 = result;
var munged_ns = cljs.core.nth.call(null,vec__26093,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26093,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26093,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26093,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26093,(4),null);
var arity = cljs.core.nth.call(null,vec__26093,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__26097 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__26097,(0),null);
var args = cljs.core.nth.call(null,vec__26097,(1),null);
var vec__26100 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26100,(0),null);
var name = cljs.core.nth.call(null,vec__26100,(1),null);
...
var G__26103 = (arity + (1));
var G__26104 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26105){
var vec__26106 = p__26105;
var arity = cljs.core.nth.call(null,vec__26106,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26106,(1),null);
...
return cljs.core.get.call(null,arities,p1__26109_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26110_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26113){
var vec__26114 = p__26113;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26114,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26111){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26122__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26122__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26122__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26122__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26123 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26123,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26123,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26123,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26123,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26123,(4),null);
var arity = cljs.core.nth.call(null,vec__26123,(5),null);
...
var o__25150__auto__ = f;
return (o__25150__auto__["getBasis"]).call(o__25150__auto__);
});
/**
...
}catch (e26127){var _e__25157__auto__ = e26127;
...
var G__26128 = (obj[cljs.core.first.call(null,path)]);
var G__26129 = cljs.core.rest.call(null,path);
obj = G__26128;
path = G__26129;
continue;
} else {
...
return (function (accum,p__26130){
var vec__26131 = p__26130;
var bit = cljs.core.nth.call(null,vec__26131,(0),null);
var protocol = cljs.core.nth.call(null,vec__26131,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26134){
var vec__26135 = p__26134;
var ns = cljs.core.nth.call(null,vec__26135,(0),null);
var name = cljs.core.nth.call(null,vec__26135,(1),null);
var selector = cljs.core.nth.call(null,vec__26135,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__26140,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26140,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26140,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26138_SHARP_){
return (obj[cljs.core.first.call(null,p1__26138_SHARP_)]);
});})(name,sorted_matches,vec__26140,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
