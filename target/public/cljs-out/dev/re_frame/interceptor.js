...
var len__4730__auto___22742 = arguments.length;
var i__4731__auto___22743 = (0);
while(true){
if((i__4731__auto___22743 < len__4730__auto___22742)){
args__4736__auto__.push((arguments[i__4731__auto___22743]));

var G__22744 = (i__4731__auto___22743 + (1));
i__4731__auto___22743 = G__22744;
continue;
} else {
}
break;
...
var id = cljs.core.get.call(null,map__22740__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var before = cljs.core.get.call(null,map__22740__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.call(null,map__22740__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5718__auto___22745 = cljs.core.seq.call(null,clojure.set.difference.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,m)),re_frame.interceptor.mandatory_interceptor_keys));
if(temp__5718__auto___22745){
var unknown_keys_22746 = temp__5718__auto___22745;
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"error","error",-978969032),"re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_22746);
} else {
}
} else {
}
...
/** @this {Function} */
re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq22738){
...
/** @this {Function} */
re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq22753){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22754,G__22755,G__22756,seq22753__$3);
});
...
var G__22760 = re_frame.interceptor.invoke_interceptor_fn.call(null,cljs.core.assoc.call(null,context__$1,new cljs.core.Keyword(null,"queue","queue",1455835879),cljs.core.pop.call(null,queue),new cljs.core.Keyword(null,"stack","stack",-793405930),cljs.core.conj.call(null,stack,interceptor)),interceptor,direction);
context__$1 = G__22760;
continue;
}
break;
}
