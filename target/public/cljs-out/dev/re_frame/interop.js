...
return [(function (){var pred__22200 = cljs.core.instance_QMARK_;
var expr__22201 = reactive_val;
if(cljs.core.truth_(pred__22200.call(null,reagent.ratom.RAtom,expr__22201))){
return "ra";
} else {
if(cljs.core.truth_(pred__22200.call(null,reagent.ratom.RCursor,expr__22201))){
return "rc";
} else {
if(cljs.core.truth_(pred__22200.call(null,reagent.ratom.Reaction,expr__22201))){
return "rx";
} else {
if(cljs.core.truth_(pred__22200.call(null,reagent.ratom.Track,expr__22201))){
return "tr";
} else {
return "other";
}
