...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24588 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24588,ch);
...
if(("\\" === ch__$1)){
var ch_24589__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24589__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24589__$2);
} else {
}

var G__24590 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24590;
continue;
}
}
...
var start_line = cljs.core.nth.call(null,vec__24598,(0),null);
var start_column = cljs.core.nth.call(null,vec__24598,(1),null);
...
var G__24601 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24601;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24602 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24603 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24603;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24602;
}});
/**
...
var vec__24613 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24613,(0),null);
var end_column = cljs.core.nth.call(null,vec__24613,(1),null);
...
var sb = (function (){var G__24622 = (new goog.string.StringBuffer());
G__24622.append(initch);
...
var G__24624 = (function (){var G__24623 = sb;
G__24623.append(ch);

return G__24623;
})();
var G__24625 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24624;
ch = G__24625;
continue;
}
...
switch (G__24628) {
case "\\":
var G__24632 = (function (){var G__24629 = sb;
G__24629.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24629;
})();
var G__24633 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24632;
ch = G__24633;
continue;
...
break;
default:
var G__24634 = (function (){var G__24630 = sb;
G__24630.append(ch);

return G__24630;
})();
var G__24635 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24634;
ch = G__24635;
continue;
...
var vec__24636 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24636,(0),null);
var end_column = cljs.core.nth.call(null,vec__24636,(1),null);
...
var vec__24639 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24639,(0),null);
var column = cljs.core.nth.call(null,vec__24639,(1),null);
...
var vec__24644 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24644,(0),null);
var column = cljs.core.nth.call(null,vec__24644,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__24654,(0),null);
var start_column = cljs.core.nth.call(null,vec__24654,(1),null);
...
var vec__24657 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24657,(0),null);
var end_column = cljs.core.nth.call(null,vec__24657,(1),null);
...
var G__24660 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24660,true,null,opts,pending_forms);
...
var G__24661 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24661)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24661)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24661)){
...
var _STAR_suppress_read_STAR__orig_val__24662 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24663 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24663;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24662;
}});
...
var G__24664 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24664,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24664,rdr,first_line);
...
var G__24669 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24668;
finished = G__24669;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24670 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24671 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24671;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24670;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_temp_val__24673 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__24673;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24674 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24674,"(");
...
var G__24675 = (i + (1));
var G__24676 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24677 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24677);
...
var G__24678 = cljs.core.next.call(null,s__$1);
var G__24679 = ret;
s__$1 = G__24678;
r = G__24679;
continue;
...
var G__24680 = cljs.core.next.call(null,s);
var G__24681 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24680;
key_vals = G__24681;
continue;
} else {
...
var gensym_env_orig_val__24685 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24686 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__24686;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__24685;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24687 = token;
var G__24687__$1 = (((G__24687 == null))?null:cljs.core.subs.call(null,G__24687,(1)));
var G__24687__$2 = (((G__24687__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24687__$1));
var G__24687__$3 = (((G__24687__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24687__$2));
var G__24687__$4 = (((G__24687__$3 == null))?null:cljs.core.symbol.call(null,G__24687__$3));
if((G__24687__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24687__$4);
}
})():(function (){var G__24688 = token;
var G__24688__$1 = (((G__24688 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24688));
if((G__24688__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24688__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24699,reader){
...
var eof = cljs.core.get.call(null,map__24700__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___24708 = arguments.length;
var i__4731__auto___24709 = (0);
while(true){
if((i__4731__auto___24709 < len__4730__auto___24708)){
args__4736__auto__.push((arguments[i__4731__auto___24709]));

var G__24710 = (i__4731__auto___24709 + (1));
i__4731__auto___24709 = G__24710;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24706){
var G__24707 = cljs.core.first.call(null,seq24706);
var seq24706__$1 = cljs.core.next.call(null,seq24706);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24707,seq24706__$1);
});
