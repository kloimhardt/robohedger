...
return [(function (){var pred__27076 = cljs.core.instance_QMARK_;
var expr__27077 = reactive_val;
if(cljs.core.truth_(pred__27076.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__27077))){
return "ra";
} else {
if(cljs.core.truth_(pred__27076.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__27077))){
return "rc";
} else {
if(cljs.core.truth_(pred__27076.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__27077))){
return "rx";
} else {
if(cljs.core.truth_(pred__27076.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__27077))){
return "tr";
} else {
return "other";
}
