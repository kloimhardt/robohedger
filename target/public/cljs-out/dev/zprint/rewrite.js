...
var G__29012 = rewrite_clj.zip.next.call(null,n);
loc = G__29012;
continue;
} else {
var G__29013 = rewrite_clj.zip.next.call(null,loc);
loc = G__29013;
continue;
}
} else {
var G__29014 = rewrite_clj.zip.next.call(null,loc);
loc = G__29014;
continue;
}
}
...
return rewrite_clj.zip.replace.call(null,zloc,rewrite_clj.zip.root.call(null,zprint.rewrite.prewalk_subtree.call(null,p_QMARK_,f,(function (){var G__29015 = zloc;
var G__29015__$1 = (((G__29015 == null))?null:rewrite_clj.zip.node.call(null,G__29015));
if((G__29015__$1 == null)){
return null;
} else {
return zprint.zutil.edn_STAR_.call(null,G__29015__$1);
}
})())));
});
/**
...
var G__29016 = rewrite_clj.zip.down.call(null,nloc);
nloc = G__29016;
continue;
}
break;
...
var G__29017 = rewrite_clj.zip.right.call(null,nloc);
var G__29018 = cljs.core.conj.call(null,out,nloc);
nloc = G__29017;
out = G__29018;
continue;
} else {
...
var G__29019 = rewrite_clj.zip.right.call(null,replaced_loc);
var G__29020 = cljs.core.next.call(null,new_loc);
var G__29021 = replaced_loc;
nloc = G__29019;
new_loc = G__29020;
last_loc = G__29021;
continue;
...
var new_dep = zprint.rewrite.prewalk.call(null,zloc,(function (p1__29022_SHARP_){
return ((cljs.core._EQ_.call(null,rewrite_clj.zip.tag.call(null,p1__29022_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.call(null,rewrite_clj.zip.sexpr.call(null,p1__29022_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
