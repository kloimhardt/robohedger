...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__29166_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__29166_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__29166_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__29167){
var vec__29168 = p__29167;
var low = cljs.core.nth.call(null,vec__29168,(0),null);
var high = cljs.core.nth.call(null,vec__29168,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__29171,s,color,element,idx){
...
var style_map = cljs.core.get.call(null,map__29172__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__29172__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__29172__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__29174){
var vec__29175 = p__29174;
var s = cljs.core.nth.call(null,vec__29175,(0),null);
var style = cljs.core.nth.call(null,vec__29175,(1),null);
var start = cljs.core.nth.call(null,vec__29175,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__29178){
var vec__29179 = p__29178;
var s = cljs.core.nth.call(null,vec__29179,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__29179,(1),null);
var element = cljs.core.nth.call(null,vec__29179,(2),null);
...
var G__29182 = cljs.core.next.call(null,ssv);
var G__29183 = (this_ssv == null);
var G__29184 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__29185 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__29182;
doing_nil_QMARK_ = G__29183;
last_elide = G__29184;
out = G__29185;
continue;
}
...
var vec__29189 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__29189,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__29189,(1),null);
var element_type = cljs.core.nth.call(null,vec__29189,(2),null);
...
var G__29192 = cljs.core.next.call(null,remaining_cvec);
var G__29193 = new_idx;
var G__29194 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__29192;
idx = G__29193;
out = G__29194;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__29205,cursor_vec){
var vec__29206 = p__29205;
var focus_start = cljs.core.nth.call(null,vec__29206,(0),null);
var focus_end = cljs.core.nth.call(null,vec__29206,(1),null);
var focus_vec = vec__29206;
...
var vec__29209 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__29209,(0),null);
var back = cljs.core.nth.call(null,vec__29209,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__29212){
var vec__29213 = p__29212;
var s = cljs.core.nth.call(null,vec__29213,(0),null);
var color = cljs.core.nth.call(null,vec__29213,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__29219,existing_count){
var vec__29220 = p__29219;
var s = cljs.core.nth.call(null,vec__29220,(0),null);
var cursor = cljs.core.nth.call(null,vec__29220,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__29220,s,cursor){
return (function (p1__29216_SHARP_){
return (!(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__29216_SHARP_))));
});})(s__$1,len,cursor__$1,vec__29220,s,cursor))
...
var vec__29227 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__29227,(0),null);
var where = cljs.core.nth.call(null,vec__29227,(1),null);
var cvec_element = vec__29227;
if((cvec_element == null)){
var G__29230 = cljs.core.next.call(null,cvec_nl);
var G__29231 = (idx + (1));
var G__29232 = start;
var G__29233 = out;
cvec_nl = G__29230;
...
var G__29234 = cljs.core.next.call(null,cvec_nl);
var G__29235 = (idx + (1));
var G__29236 = idx;
var G__29237 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__29234;
idx = G__29235;
start = G__29236;
out = G__29237;
...
var G__29238 = cljs.core.next.call(null,cvec_nl);
var G__29239 = (idx + (1));
var G__29240 = (idx + (1));
var G__29241 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__29238;
idx = G__29239;
start = G__29240;
out = G__29241;
...
var G__29242 = cljs.core.next.call(null,cvec_nl);
var G__29243 = (idx + (1));
var G__29244 = idx;
var G__29245 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__29242;
idx = G__29243;
start = G__29244;
out = G__29245;
...
var G__29246 = cljs.core.next.call(null,cvec_nl);
var G__29247 = (idx + (1));
var G__29248 = start;
var G__29249 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__29246;
idx = G__29247;
start = G__29248;
out = G__29249;
...
return cljs.core.reduce.call(null,(function (p1__29251_SHARP_,p2__29250_SHARP_){
if(zprint.finish.within_QMARK_.call(null,idx,p2__29250_SHARP_)){
return cljs.core.reduced.call(null,p1__29251_SHARP_);
} else {
return (p1__29251_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__29252,p__29253){
var vec__29254 = p__29252;
var focus_begin = cljs.core.nth.call(null,vec__29254,(0),null);
var focus_end = cljs.core.nth.call(null,vec__29254,(1),null);
var vec__29257 = p__29253;
var before = cljs.core.nth.call(null,vec__29257,(0),null);
var after = cljs.core.nth.call(null,vec__29257,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__29261,cvec,focus_vec){
...
var options = map__29262__$1;
var map__29263 = cljs.core.get.call(null,map__29262__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.call(null,map__29263__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__29263__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__29263__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__29262,map__29262__$1,options,map__29263,map__29263__$1,focus,lines,paths){
return (function (p1__29260_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__29260_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__29262,map__29262__$1,options,map__29263,map__29263__$1,focus,lines,paths))
,path_vecs);
